...
RENAME customers TO old_customers;
...
CONSTRAINT CK__Products_UnitPrice   CHECK ((UnitPrice >= 0)), 
CONSTRAINT CK__ReorderLevel   CHECK ((ReorderLevel >= 0)), 
CONSTRAINT CK__UnitsInStock   CHECK ((UnitsInStock >= 0)), 
CONSTRAINT CK__UnitsOnOrder   CHECK ((UnitsOnOrder >= 0)), 
CONSTRAINT FK__Products_Categories FOREIGN KEY (CategoryID) REFERENCES Categories(CategoryID), 
CONSTRAINT FK__Products_Suppliers FOREIGN KEY (SupplierID) REFERENCES Suppliers(SupplierID)
);
...
CONSTRAINT PK__Orders 
  PRIMARY KEY (OrderID), 
CONSTRAINT FK__Orders_Customers FOREIGN KEY (CustomerID) REFERENCES Customers(CustomerID), 
CONSTRAINT FK__Orders_Employees FOREIGN KEY (EmployeeID) REFERENCES Employees(EmployeeID), 
CONSTRAINT FK__Orders_Shippers FOREIGN KEY (ShipVia) REFERENCES Shippers(ShipperID),
CONSTRAINT FK__Orders_Territories FOREIGN KEY (TerritoryID) REFERENCES Territories(TerritoryID)
); 
...
( 
  ...
  CustomerDesc  LONG, 
CONSTRAINT PK__CustomerDemographics 
...
SELECT  Suppliers.SupplierID as supplier_id, Suppliers.CompanyName as name, 
Products.ProductID as P_id, Products.ProductName as P_name 
